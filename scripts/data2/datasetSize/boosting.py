...
for data_size in range(1,10):
        cls = AdaBoostClassifier(tree.DecisionTreeClassifier(max_depth=79),n_estimators=15)
        size = 1 - (data_size * 0.1)
        print "test size: " , size
        X_train, X_test, y_train, y_test = train_test_split(x, y, test_size=size, random_state=51)
